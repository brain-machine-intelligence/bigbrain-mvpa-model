...
if(myArbitrator.ind_active_model==1)
    myState=myState1; % fwd learner, in general
else
    myState=myState2; % sarsa learner, in general
end
...
% fprintf("(Arbitration_v4) S,A: %d,%d ", myArbitrator.state_history(myArbitrator.index), myArbitrator.action_history(myArbitrator.index))
