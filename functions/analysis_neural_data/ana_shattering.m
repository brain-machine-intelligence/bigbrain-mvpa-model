...
% except AAL
ROI = {'F3TL', 'F3TR', 'ACCL', 'ACCR', 'preSMAL', 'preSMAR', 'V1L', 'V1R', 'HIPPOL', 'HIPPOR', 'VentStrL', 'VentStrR'};
...
% LABEL = {'Goal(6,7,8)xUC LOROV perm'}; N_allclass = 6 * ones(1, length(LABEL)); trialSelect = {[]};
...
% ROI_types = {};
% original set
% ROI_types = {'AAL3', 'AAL3', 'AAL3', 'AAL3', 'AAL3', 'AAL3', 'AAL3', 'AAL3', 'AAL', 'AAL', 'AAL'};
% full set
% ROI_types = {'AAL3', 'AAL3', 'AAL', 'AAL', 'AAL', 'AAL3', 'AAL3', 'JuBrain', 'JuBrain', 'AAL3', 'AAL3', 'AAL3', 'AAL3', 'AAL3', 'AAL3'};
% except AAL
ROI_types = {'AAL3', 'AAL3', 'AAL3', 'AAL3', 'JuBrain', 'JuBrain', 'AAL3', 'AAL3', 'AAL3', 'AAL3', 'AAL3', 'AAL3'};
% new set
    ...
    for labi = 1:length(LABEL)
        ...
        for evi = 1:length(EVENT)
            ...
            if length(unqSet)~=N_allclass(labi) 
                disp('(ana_shattering) label element error'); 
                continue
            end
