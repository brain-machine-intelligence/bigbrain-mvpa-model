...
switch options.Exp
    case {'Lee2014', 'Lee2014pp2', 'Heo2021', 'Shin2025'}
        ...
        try
            ...
            fprintf('Error in SARtime_to_MRIidx.m: ')
            disp(Err.message)
            ...
            % 6(+/-)0.1: O1(with win/lost msg), 
            % 7(+/-)0.1: O2(with win/lost msg), 
            % 8(+/-)0.1: O3(with win/lost msg), 
            % 9: O4, 
            % 10:A1, 11:A2, 
            % 20: a short blank page display, 
