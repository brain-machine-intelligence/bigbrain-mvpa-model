...
% ROI = {'F3TL', 'F3TR', 'DLPFCL', 'DLPFCR', 'OFC'}; % 22-02-09 Goal(6,7,8) x Unc LOROV mixing
...
% LABEL = {'Coin(1,2,3) binPMB 0 LOROV', 'Coin(1,2,3) binPMB 1 LOROV'};  
...
% LABEL = {'Goal(1,2,3) x Unc LOROV'};     % 210330 for Kim2019 
...
% LABEL = {'UncCond P1 LOROV', 'UncCond P2 LOROV', 'UncCond P3 LOROV'};    

% ----- basic taskVar -----
% LABEL = {'UncCond at state 4'}; N_allclass = 2 * ones(1, length(LABEL)); trialSelect = {'H'};
% LABEL = {'S3 run2345'};     % 2021-06-03 label runs test
% LABEL = {'GoalCond', 'UncCond', 'Interaction'};    % 2021-05-09 Lee2014
% LABEL = {'UncCond'}; N_allclass = 2 * ones(1, length(LABEL)); trialSelect = {[]};
% LABEL = {'UncCond'}; N_allclass = 2 * ones(1, length(LABEL)); trialSelect = {'Goal6'};
% LABEL = {'UncCond'}; N_allclass = 2 * ones(1, length(LABEL)); trialSelect = {'Goal7'};
% LABEL = {'UncCond'}; N_allclass = 2 * ones(1, length(LABEL)); trialSelect = {'Goal8'};
% LABEL = {'UncCond'}; N_allclass = 2 * ones(1, length(LABEL)); trialSelect = {'Goal(6,-1)'};
% LABEL = {'UncCond'}; N_allclass = 2 * ones(1, length(LABEL)); trialSelect = {'Goal(6,8)'};
% LABEL = {'UncCond', 'UncCond', 'UncCond', 'UncCond'}; N_allclass = 2 * ones(1, length(LABEL)); trialSelect = {'G uLate', 'G uEarly', 'H uLate', 'H uEarly'};
LABEL = {'UncCond', 'UncCond'}; N_allclass = 2 * ones(1, length(LABEL)); trialSelect = {'G', 'H'};
% LABEL = {'UncCond G LOROV'}; % environmental information (UC) check in G trials
% LABEL = {'UncCond H LOROV'}; % environmental information (UC) check in G trials
% LABEL = {'UC hCX LOROV', 'UC lCX LOROV', 'CX hUC LOROV', 'CX lUC LOROV'}; 
% LABEL = {'GoalCond LOROV', 'UncCond LOROV', 'Interaction LOROV'};
% LABEL = {'CmplxCond LOROV', 'UncCond LOROV'};
% LABEL = {'CmplxCond', 'UncCond', 'Interaction'};  % 2021-05-09 Kim2019
% LABEL = {'blkCond'};
% LABEL = {'S2'};
% LABEL = {'S3'};
% LABEL = {'S2 LOROV', 'S3 LOROV', 'R LOROV'}; N_allclass = 4 * ones(1, length(LABEL)); trialSelect = {'G', 'G', 'G'};
% LABEL = {'S3(6,7,8) LOROV', 'R(10,20,40) LOROV'}; N_allclass = 3 * ones(1, length(LABEL)); trialSelect = {'G', 'G', 'G'};
% LABEL = {'blkCond', 'S2', 'S3'};
% LABEL = {'blkCond', 'S2', 'Coin'};  % 2021-03-25
% LABEL = {'S2 LOROV', 'Coin LOROV'};
% LABEL = {'Goal'};
...
% LABEL = {'AchGoalS1RandA uL LOROV'};
% LABEL = {'AchGoalS1RandA LOROV', 'AchGoalS1OptA LOROV', 'AchGoalS2RandA LOROV', 'AchGoalS2OptA LOROV'};
% LABEL = {'Goal uL cL LOROV', 'Goal uL cH LOROV', ... 
%     'AchGoalS1RandA uL cL LOROV', 'AchGoalS1RandA uL cH LOROV', 'AchGoalS2RandA uL cL LOROV', 'AchGoalS2RandA uL cH LOROV'};
% LABEL = {'AchGoalS1OptA uL LOROV', 'AchGoalS2RandA uL LOROV', 'AchGoalS2OptA uL LOROV'};
% LABEL = {'AchGoalS2OptA LOROV' 'AchGoalS2OptA uL LOROV'};
...
% ----- latent RL signal -----
% LABEL = {'binRPE2 G LOROV', 'binRPE3 G LOROV'};     % 2022-07-21
% LABEL = {'binSPE2 G LOROV', 'binSPE3 G LOROV'};     % 2022-07-20
% LABEL = {'RPE', 'SPE'};     % 2021-05-22
% LABEL = {'binRelMB', 'binRelMF', 'binRelMAX'};     % 2021-06-02
% LABEL = {'binRelMB LOROV', 'binRelMF LOROV', 'binRelMAX LOROV'};     % 2022-02-15
% LABEL = {'binRelMB3lev LOROV', 'binRelMF3lev LOROV', 'binRelMAX3lev LOROV'};
% LABEL = {'relComp2 G LOROV', 'relComp3 G LOROV'};     % 2022-07-21


% ----- BHV related embedding -----
% 2021-11-15 sbj1~6 run finish
% LABEL = {'Goal(6,7,8) binPMB_G0 LOROV', 'Goal(6,7,8) binPMB_G1 LOROV'}; 
% LABEL = {'UC binPMB0 LOROV', 'UC binPMB1 LOROV', 'UC binChoOpt0 LOROV', 'UC binChoOpt1 LOROV'}; 
% LABEL = {'Goal binPMB0 LOROV', 'Goal binPMB1 LOROV', ... 
%     'Goal binPMB1 uL LOROV', 'Goal binPMB1 uH LOROV'};
% LABEL = {'Goal binPMB1 LOROV'};
% LABEL = {'Goal binPMB1 uH LOROV'};
...
% ----- strategy control -----
% LABEL = {'UncCond binPMB_G0 LOROV', 'UncCond binPMB_G1 LOROV'}; % 22-02-09 uncertainty representation control?
